...
<html>
    ...
    <body>
        ...
        <div id="show-prodotto" class="content scaffold-show" role="main">
            ...
            <f:display bean="prodotto" />
            <g:form resource="${this.prodotto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.prodotto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
